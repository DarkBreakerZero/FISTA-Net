...
root_dir = '/home/10T/DreamNet/Data/AAPM/'
case_list = os.listdir(root_dir)

for index, case in enumerate(case_list):

    hdproj_save_path = '/home/10T/DreamNet/Data/sAAPMProj/' + case + '/clean_proj/'
    ldproj_save_path = '/home/10T/DreamNet/Data/sAAPMProj/' + case + '/noisy_proj_1e6/'
    ldct_save_path = '/home/10T/DreamNet/Data/sAAPMImg/' + case + '/sparse_ct_v' + str(576//rate) + '_1e6/'
